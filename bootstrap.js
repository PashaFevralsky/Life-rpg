...
/* Life RPG 12.0.3 — modular runtime bootstrap + Growth OS + Personal OS */
const LIFE_RPG_RUNTIME_MODULES=[
  ...
  "knowledge-growth.js","work-growth.js","tennis-growth.js","tennis-huawei.js","tennis-decision.js","rpg-growth.js","life-os.js","today-execution.js","personal-integration-os.js"
];
...
function lifeInstallRuntime(){
  ...
  const renderPipeline=[
    ...
    ["ensureKnowledgeGrowthUi","renderKnowledgeGrowth"],["ensureTennisGrowthUi","renderTennisGrowth"],["ensureTennisDecision22Ui","renderTennisDecision22"],["ensureTodayExecution123Ui","renderTodayExecution123"],["ensureRpgGrowthUi","renderRpgGrowth"],["ensurePersonalImportUi","renderPersonalImportUi"],["ensureDashboardOsUi","renderDashboardOs"]
  ];
  render=function(){
    baseRender();
