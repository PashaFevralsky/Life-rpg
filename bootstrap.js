...
/* Life RPG 11.1.1 — modular runtime bootstrap + Growth OS */
const LIFE_RPG_111_MODULES=[
  ...
  "tracking-os.js","knowledge-growth.js","tennis-growth.js","rpg-growth.js",
  "life-os.js"
];
...
function life111InstallRuntime(){
  ...
  const baseSwitchTab=switchTab;switchTab=function(id){baseSwitchTab(id);requestAnimationFrame(()=>{const view=UX7_PREFS[id]||UX7_DEFAULTS[id];ux7SetView(id,view,false);ux7RefreshHeaders();ui82SyncChrome(id,view)})}
}
