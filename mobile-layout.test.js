...
assert.ok(html.includes('mobile-layout.css?v=12.0.2'),"mobile layout stylesheet is not loaded after base CSS");
...
console.log("OK — Life RPG 12.0.2 mobile layout static contract passed");
