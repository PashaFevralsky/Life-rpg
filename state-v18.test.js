...
assert.equal(migrated.settings.decisionPreferences.x.scoreDelta,20);assert.equal(migrated.settings.executionHorizonDays,7);assert.equal(migrated.settings.calibration.capacityFactor,.95);
