...
assert.ok(core.includes('APP_VERSION="13.2.0"'));assert.ok(core.includes("STATE_VERSION=18"),"13.1 must not migrate state");
...
assert.ok(vite.includes('importScripts:["share-target-sw.js"]'));assert.ok(vite.includes('cacheId:"life-rpg-13.2.0"'));assert.ok(vite.includes('"share-hub.js"'));assert.ok(vite.includes('"share-target-sw.js"'));
