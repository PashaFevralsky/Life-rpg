...
Version 8.0 replaces the former monolithic `app.js` runtime with classic browser modules that share one global application context and require no build step:
